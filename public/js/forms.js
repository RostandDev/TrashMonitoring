        ...
        function userform(){
            ...
            form_container.innerHTML = `<form id="userAdd">
                <div class="close">×</div>
                <div>
                    <div classe ="title">Nom</div>
                    <input type="text" id="_last_name">
                </div>
                <div>
                    <div classe ="title">Prenoms</div>
                    <input type="text" id="_first_name">
                </div>
                <div>
                    <div classe ="title">Email</div>
                    <input type="text" id="_email">
                </div>
                <div>
                    <div classe ="title">Identifiant</div>
                    <input type="text" id="_identifier">
                </div>
                <div>
                    <div classe ="title">Mot de passe </div>
                    <input type="text" id="_password">
                </div>
                <div>
                    <input type="button" id="useradd" value="Enregistrer">
                </div>
            </form>`;
        ...
        function user_updataform(){
            ...
            form_container.innerHTML = `<form id="userUpdate"><div class="close">×</div><div><div classe ="title">Nom</div><input type="text" id="u_last_name"></div><div><div classe ="title">Prenoms</div><input type="text" id="u_first_name"></div><div><div classe ="title">Email</div><input type="text" id="u_email"></div><div><div classe ="title">Identifiant</div><input type="text" id="u_identifier"></div><div><div classe ="title">Mot de passe </div><input type="text" id="u_password"></div><div><select id="u_access_level"><option value="reader">Simple utilisateur</option><option value="editor">Administrateur</option></select></div><div><input type="button" id="u_update" value="Enregistrer"></div><input id="u_id" type="hidden"></form>`;
